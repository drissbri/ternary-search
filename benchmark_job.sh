...
# TST Benchmarking Job Script for VSC HPC
...
# No need for virtual environment - using modules
# Verify environment
...
# Run the benchmark with smaller sizes for initial testing
echo "Running basic benchmark..."
python benchmark_tst.py --output-dir "${OUTPUT_DIR}/basic" --max-size 10000
...
echo "Benchmark completed successfully" > "${OUTPUT_DIR}/summary.txt"
